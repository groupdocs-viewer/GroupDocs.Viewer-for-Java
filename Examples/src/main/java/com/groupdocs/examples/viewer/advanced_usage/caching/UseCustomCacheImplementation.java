...
import com.groupdocs.examples.viewer.advanced_usage.caching.jackson.JacksonCache;
import com.groupdocs.examples.viewer.advanced_usage.caching.jackson.JacksonCacheableFactory;
...
public class UseCustomCacheImplementation {
    ...
    public static void run(Path inputFile) {
        Path outputDirectory = FilesUtils.makeOutputPath("UseCustomCacheImplementation");

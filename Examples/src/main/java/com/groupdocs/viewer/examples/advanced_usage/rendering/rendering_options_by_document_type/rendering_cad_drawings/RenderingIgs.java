...
public class RenderingIgs {
    public static void run() throws IOException {
        ...
        String pageFilePathFormat = PathUtils.combine(outputDirectory, "IGS_result.html");

        // TO HTML
        try (Viewer viewer = new Viewer(SampleFiles.SAMPLE_IGS)) {
        ...
        // TO JPG
        pageFilePathFormat = PathUtils.combine(outputDirectory, "IGS_result.jpg");
        ...
        // TO PNG
        pageFilePathFormat = PathUtils.combine(outputDirectory, "IGS_result.png");
        ...
        // TO PDF
        pageFilePathFormat = PathUtils.combine(outputDirectory, "IGS_result.pdf");

 ...
 */
@WebServlet("/GetPdfDownloadUrl")
public class GetPdfDownloadUrl extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String r = GetFileUrl(parameters.getPath(), true, false, parameters.getFileDisplayName(),

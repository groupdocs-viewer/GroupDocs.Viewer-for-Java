...
public class ViewerUtils {
    ...
    public static final Path STORAGE_PATH = getProjectBaseDir().resolve("storage");
    public static final Path TEMP_PATH = FileSystems.getDefault().getPath(System.getProperty("java.io.tmpdir"));
    ...
    public static ViewerHtmlHandler getViewerHtmlHandler() {
        if (_htmlHandler == null) {
            ...
            htmlConfig.setStoragePath(STORAGE_PATH.toString());
            htmlConfig.setTempPath(TEMP_PATH.toString());
    ...
    public static ViewerImageHandler getViewerImageHandler() {
        if (_imageHandler == null) {
            ...
            imageConfig.setStoragePath(STORAGE_PATH.toString());
            imageConfig.setTempPath(TEMP_PATH.toString());
    ...
    public static FileData factoryFileData(String path) {

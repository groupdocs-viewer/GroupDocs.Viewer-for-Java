...
Download [source code](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v24.10/groupdocs-viewer-micronaut-24.10.zip) from github or clone this repository.
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v24.10/groupdocs-viewer-micronaut-24.10.tar
tar -xvzf release.tar.gz
cd release/viewer-micronaut-24.10

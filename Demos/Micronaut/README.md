...
Download [source code](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v22.12/groupdocs-viewer-micronaut-22.12.0.zip) from github or clone this repository.
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v22.12/groupdocs-viewer-micronaut-22.12.0.tar
tar -xvzf release.tar.gz
cd release/viewer-micronaut-22.12

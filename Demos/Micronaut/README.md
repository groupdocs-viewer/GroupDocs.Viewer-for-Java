# GroupDocs.Viewer for Java - Micronaut Demo

A web-based document viewer built with [GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java) and Micronaut 3.4 (Kotlin).

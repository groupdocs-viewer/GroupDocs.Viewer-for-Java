# GroupDocs.Viewer for Java - Ktor Demo

A web-based document viewer built with [GroupDocs.Viewer for Java](https://products.groupdocs.com/viewer/java) and Ktor (Kotlin).

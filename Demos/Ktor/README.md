...
Download [source code](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v25.2/groupdocs-viewer-ktor-25.2.zip) from github or clone this repository.
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v25.2/groupdocs-viewer-ktor-25.2.tar
tar -xvzf release.tar.gz
cd release/viewer-ktor-25.2

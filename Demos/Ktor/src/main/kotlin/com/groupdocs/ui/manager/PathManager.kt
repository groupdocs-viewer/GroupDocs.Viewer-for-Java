...
class PathManagerImpl(
    private val viewerConfig: com.groupdocs.ui.config.ViewerConfig
) : PathManager, KoinComponent {
    private val isLocalProvider: Boolean by lazy {
        viewerConfig.viewer.filesProviderTypeOrDefault == Defaults.Viewer.FilesProviderType.LOCAL
    }

    override val tempDirectory: Path by lazy {
        val absoluteOrRelativeTempDirectory = Paths.get(viewerConfig.viewer.tempDirectoryOrDefault)
    ...
    override val resultDirectory: Path by lazy {
        ...
        val absoluteOrRelativeResultDirectory = viewerConfig.local.resultDirectoryOrDefault
    ...
    override val filesDirectory: Path by lazy {
        ...
        val absoluteOrRelativeFilesDirectory = viewerConfig.local.filesDirectoryOrDefault

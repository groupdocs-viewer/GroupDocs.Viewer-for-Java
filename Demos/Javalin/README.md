...
Download [source code](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v24.4/groupdocs-viewer-javalin-24.4.zip) from github or clone this repository.
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Java/releases/download/v24.4/groupdocs-viewer-javalin-24.4.tar
tar -xvzf release.tar.gz
cd release/viewer-javalin-24.4
